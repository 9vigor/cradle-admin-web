...
<script lang="ts">
  ...
  import { formSchema } from './memberInfo.data';
  import { BasicDrawer, useDrawerInner } from '/@/components/Drawer';
  import { saveMemberInfo, updateMemberInfo } from '/@/api/member/memberInfo';
  import { useI18n } from '/@/hooks/web/useI18n';

  export default defineComponent({
    name: 'MemberInfoDrawer',
